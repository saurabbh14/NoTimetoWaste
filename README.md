...
**Test Case 2: Random Routes for Multi-Fleet Testing**
Automatically generate random safe locations in Jena for stress-testing.
```json
{
  "mode": "random",
  "trucks": [
    {"truck_id": "Truck 1", "num_points": 5},
    {"truck_id": "Truck 2", "num_points": 5},
    {"truck_id": "Truck 3", "num_points": 5}
  ]
}
```
...
1. **Color-Coded Fleets:** Each truck operates simultaneously on the map using a distinct color.
2. **Numbered Stops:** Explicit numbering showing the optimal pickup order for every truck.
3. **Animated Directional Arrows:** Folium AntPath animations indicating the precise direction of travel.
4. **Round Trip Guarantee:** Every truck is routed to safely return to the KSJ Depot at the end of their shift.
